...
<div class="sectionSurvey">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" ShowHeader="false" Width="950px">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
<div class="form-group">
							<div class="control-group">
                                ...
                                <asp:RadioButtonList ID="r1" runat="server" 
                                    DataSource=<%#getans(Convert.ToInt32(Eval("qstcod"))) %>
                                    DataTextField="ansdsc" DataValueField="anssts" Height="16px" RepeatColumns="2" RepeatDirection="Horizontal" Width="924px"
                                    >
